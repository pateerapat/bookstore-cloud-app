...
app.post("/register", async (req, res, next) => {
    ...
    axios({
        method: "POST",
        url: "34.204.12.146:5000//users/register",
        data: {
...
app.post("/login", async (req, res, next) => {
    axios({
        method: "POST",
        url: "34.204.12.146:5000//users/login",
        data: {
            username: req.body.username,
            password: req.body.password,
        }
...
app.get("/change-password", ifNotLoggedIn, async (req, res, next) => {
    const responseUserData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//users/get/data",
        headers: {
    ...
    const responsePointData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//users/get/point",
        headers: {
            authorization: "bearer " + req.session.token,
        }
    })
    const responseCartData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//carts/get/all",
        headers: {
            authorization: "bearer " + req.session.token,
        }
    })
...
app.post("/change-password", ifNotLoggedIn, async (req, res, next) => {
    ...
    const response = await axios({
        method: "POST",
        url: "34.204.12.146:5000//users/change/password",
        headers: {
            authorization: "bearer " + req.session.token,
        },
        data: {
...
app.get("/", ifNotLoggedIn, async (req, res, next) => {
    ...
    const responseBooksData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//books/get/all",
    })
    const responseCartData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//carts/get/all",
...
app.post("/search", ifNotLoggedIn, async (req, res, next) => {
    ...
    let toRequest;
    if (req.body.search == "") {
        toRequest = "34.204.12.146:5000//books/get/all";
    } else {
        toRequest = "34.204.12.146:5000//books/search/"+req.body.search;
    }
    const responseBooksData = await axios({
        method: "GET",
        url: toRequest,
...
app.get("/book/:id", ifNotLoggedIn, async (req, res, next) => {
    ...
    const responseBooksData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//books/get/book/"+req.params.id,
    })
    const responseCommentsData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//comments/book/"+req.params.id,
    })
    const responseCartData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//carts/get/all",
...
app.post("/like", ifNotLoggedIn, async (req, res, next) => {
    const response = await axios({
        method: "POST",
        url: "34.204.12.146:5000//comments/"+req.body.id+"/like",
    })
    res.redirect("back");
});
...
app.post("/post", ifNotLoggedIn, async (req, res, next) => {
    const response = await axios({
        method: "POST",
        url: "34.204.12.146:5000//comments/book/"+req.body.id,
        headers: {
            authorization: "bearer " + req.session.token,
        },
        data: {
...
app.post("/addToCart", ifNotLoggedIn, async (req, res, next) => {
    const response = await axios({
        method: "POST",
        url: "34.204.12.146:5000//carts/add",
        headers: {
            authorization: "bearer " + req.session.token,
        },
        data: {
...
app.post("/buy", ifNotLoggedIn, async (req, res, next) => {
    ...
    let responseAddOrderData = await axios({
        method: "POST",
        url: "34.204.12.146:5000//orders/add",
        headers: {
            authorization: "bearer " + req.session.token,
        },
    })
    ...
    responseCartData.forEach(async (element) => {
        await axios({
            method: "POST",
            url: "34.204.12.146:5000//order-items/add",
            headers: {
                authorization: "bearer " + req.session.token,
            },
            data: {
    ...
    let responsePointData = await axios({
        method: "POST",
        url: "34.204.12.146:5000//users/point",
        headers: {
            authorization: "bearer " + req.session.token,
        },
        data: {
    ...
    const responseClearCart = await axios({
        method: "POST",
        url: "34.204.12.146:5000//carts/clear",
        headers: {
            authorization: "bearer " + req.session.token,
        },
    })
...
app.get("/orders", ifNotLoggedIn, async (req, res, next) => {
    ...
    const responseOrdersData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//orders/get/all",
        headers: {
            authorization: "bearer " + req.session.token,
        }
    })
...
app.get("/order/:id", ifNotLoggedIn, async (req, res, next) => {
    ...
    const responseOrdersData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//order-items/get/" + req.params.id,
        headers: {
            authorization: "bearer " + req.session.token,
        }
    })
...
app.post("/change-status", ifNotLoggedIn, async (req, res, next) => {
    const response = await axios({
        method: "POST",
        url: "34.204.12.146:5000//orders/status",
        headers: {
            authorization: "bearer " + req.session.token,
        },
        data: {
...
app.get("/prizes", ifNotLoggedIn, async (req, res, next) => {
    ...
    const responsePrizesData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//prizes/get/all",
    })
...
app.post("/redeem", ifNotLoggedIn, async (req, res, next) => {
    const response = await axios({
        method: "POST",
        url: "34.204.12.146:5000//prize-history/history",
        headers: {
            authorization: "bearer " + req.session.token,
        },
        data: {
...
app.get("/prizes-history", ifNotLoggedIn, async (req, res, next) => {
    ...
    const responseHistoryData = await axios({
        method: "GET",
        url: "34.204.12.146:5000//prize-history/get/history",
        headers: {
            authorization: "bearer " + req.session.token,
        },
    })
